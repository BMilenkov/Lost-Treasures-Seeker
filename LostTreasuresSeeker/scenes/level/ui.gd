...
var time_left = 70  # Set initial time in seconds
...
func update_timer_label():
	var minutes = time_left / 60  # Calculate minutes
	var seconds = time_left % 60  # Calculate remaining seconds
	timer_label.text = "Time left: " + str(minutes).pad_zeros(2) + ":" + str(seconds).pad_zeros(2)
